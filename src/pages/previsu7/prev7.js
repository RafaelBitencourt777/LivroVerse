            ...
            <div className='Meio'>
                <div className='quad'>
                    ...
                    <div className='img' alt='aqui seria a imagem do livro'>
                        <img src={principe} alt="Imagem do livro" />
                    </div>
                        ...
                        <div className='titulo-e-heart'>
                         <div className='textos'>
                            ...
                            <h4>Por <label>Antoine de Saint-Exupéry</label></h4>
                        </div>
                        <img
                         ...
                         />
                            ...
                            <div className='desc'>
                                <h3><b>Descrição:</b></h3>
                                <p>Uma história filosófica e encantadora que explora temas como a amizade, o amor e a busca por significado na vida, através das experiências de um pequeno príncipe.</p>
                            </div>
