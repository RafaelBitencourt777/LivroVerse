...
export default function Prev10() {
            ...
            <div className='Meio'>
                <div className='quad'>
                    ...
                    <div className='img' alt='aqui seria a imagem do livro'>
                        <img src={codigo} alt="Imagem do livro" />
                    </div>
                        ...
                        <div className='titulo-e-heart'>
                         <div className='textos'>
                            ...
                            <h4>Por <label> Dan Brown</label></h4>
                        </div>
                        <img
                         ...
                         />
                            ...
                            <div className='desc'>
                                <h3><b>Descrição:</b></h3>
                                <p>Um thriller de mistério que envolve simbologia, arte e religião. O professor Robert Langdon é chamado para desvendar um código em um assassinato no Louvre, desencadeando uma trama de conspiração.</p>
                            </div>
