            ...
            <div className='Meio'>
                <div className='quad'>
                    ...
                    <div className='img' alt='aqui seria a imagem do livro'>
                        <img src={dom} alt="Imagem do livro" />
                    </div>
                        ...
                        <div className='titulo-e-heart'>
                         <div className='textos'>
                            <h3>Dom Quixote</h3>
                            <h4>Por <label>Miguel de Cervantes</label></h4>
                        </div>
                        <img
                         ...
                         />
                            ...
                            <div className='desc'>
                                <h3><b>Descrição:</b></h3>
                                <p> Considerado o primeiro romance moderno, "Dom Quixote" é uma sátira às novelas de cavalaria. Conta a história de um fidalgo que enlouquece após ler muitos romances e decide se tornar um cavaleiro errante.</p>
                            </div>
