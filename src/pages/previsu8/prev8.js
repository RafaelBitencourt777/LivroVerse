            ...
            <div className='Meio'>
                <div className='quad'>
                    ...
                    <div className='img' alt='aqui seria a imagem do livro'>
                        <img src={livros} alt="Imagem do livro" />
                    </div>
                        ...
                        <div className='titulo-e-heart'>
                         <div className='textos'>
                            ...
                            <h4>Por <label>Markus Zusak</label></h4>
                        </div>
                        <img
                         ...
                         />
                            ...
                            <div className='desc'>
                                <h3><b>Descrição:</b></h3>
                                <p>Ambientado durante a Segunda Guerra Mundial na Alemanha, o livro é narrado pela Morte e segue a história de Liesel Meminger, uma jovem que rouba livros para compartilhar com os outros durante tempos difíceis.</p>
                            </div>
